...
const keyMetrics = [
  ...
  { icon: Award, value: "Microsoft", label: "Startup Program", color: "text-blue-500" },
  { icon: Shield, value: "SOC2/OWASP", label: "Compliance Ready", color: "text-green-500" },
]

const features = [
  { name: "VSCode Extension", description: "Seamless Rust & TypeScript integration.", iconColor: "bg-blue-500" },
  { name: "SOC2 Compliance", description: "Automated checks & evidence gathering.", iconColor: "bg-green-500" },
  { name: "OWASP Standards", description: "Proactive vulnerability scanning.", iconColor: "bg-yellow-500" },
  { name: "Real-time Monitoring", description: "Continuous security assessment.", iconColor: "bg-purple-500" },
  { name: "Automated Reporting", description: "Comprehensive compliance documentation.", iconColor: "bg-red-500" },
  { name: "Team Collaboration", description: "Secure multi-user workspace.", iconColor: "bg-teal-500" },
]

const recognitions = [
  {
    name: "Microsoft Startup Program",
    detail: "Accepted into Microsoft's prestigious startup accelerator program.",
    badgeColor: "bg-blue-600 text-blue-50",
  },
  {
    name: "Buildspace S5",
    detail: "Selected for Buildspace Season 5 cohort, a top-tier builder community.",
    badgeColor: "bg-purple-600 text-purple-50",
  },
  {
    name: "100+ User Milestone",
    detail: "Rapid user adoption and positive feedback within the first 6 months.",
      ...
      >
        ...
        <ScrollArea className="flex-1">
          <div className="p-6 space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <Card className="overflow-hidden shadow-xl border-0 bg-gradient-to-br from-secondary via-background to-secondary">
                <CardHeader className="p-0">
                  <div className="aspect-video bg-black rounded-t-lg flex items-center justify-center relative overflow-hidden group">
                    ...
                    <div className="text-center text-white z-10 p-8">
                      ...
                      <h3 className="text-3xl font-bold mb-3 drop-shadow-md">Ares Security Platform Demo</h3>
                      <p className="text-lg text-gray-200 mb-6 max-w-md mx-auto drop-shadow-sm">
                        See how Ares simplifies SOC2 & OWASP compliance for your development workflow.
                      </p>
                      <Button
                        size="lg"
                ...
                <CardContent className="p-6 bg-background">
                  <h3 className="text-xl font-semibold mb-3 text-foreground">Empowering Secure Development</h3>
                  <p className="text-muted-foreground">
                    Ares provides a comprehensive suite of tools to integrate security best practices directly into your
                    CI/CD pipeline, ensuring continuous compliance and robust protection against vulnerabilities.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {keyMetrics.map((metric, index) => (
                      ...
                      >
                        <metric.icon className={`h-10 w-10 mb-3 ${metric.color}`} />
            ...
            >
              <Card className="bg-card border-border shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl font-semibold text-foreground">Core Platform Features</CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    {features.map((feature, index) => (
                      ...
                      >
                        <div className="flex items-start gap-4">
                          <div className={`w-3 h-3 ${feature.iconColor} rounded-full mt-1.5 flex-shrink-0`}></div>
                          <div>
            ...
            >
              <Card className="bg-card border-border shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl font-semibold text-foreground">Recognition & Achievements</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {recognitions.map((rec, index) => (
                    ...
                    >
                      ...
                      <div>
                        <Badge className={`mb-1 text-xs px-2 py-0.5 ${rec.badgeColor}`}>{rec.name}</Badge>
        ...
        <DialogFooter className="px-6 py-4 border-t border-border bg-background sticky bottom-0 z-20">
          <Button
            ...
            onClick={() => window.open("https://ares-security.com/request-demo", "_blank")}
          >
            Request a Demo
          </Button>
        </DialogFooter>
