                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold text-white mb-2 tracking-wide">{exp.title}</h3>
                            <a
                              href={exp.link}
                              target="_blank"
                        ...
                        <p className="text-slate-300 text-lg leading-relaxed mb-6 font-light">{exp.description}</p>
                        ...
                        <ul className="space-y-4">
                          {exp.achievements.map((achievement, i) => (
                            <li key={i} className="flex items-start gap-3">
                              ...
                              />
                              <span className="text-slate-300 leading-relaxed font-light">{achievement}</span>
                            </li>
                          ))}
                        </ul>
                      </motion.div>
