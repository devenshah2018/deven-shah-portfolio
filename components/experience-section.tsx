...
export function ExperienceSection() {
  ...
  return (
    <section
      id="experience"
      className="py-20 sm:py-28 bg-gradient-to-b from-slate-900 to-slate-950"
    >
      <div className="container mx-auto px-3 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-10 sm:mb-14">
            ...
            >
              Intern to co-founder—driving innovation, building teams, and
              delivering transformative technology across fintech, AI, and
