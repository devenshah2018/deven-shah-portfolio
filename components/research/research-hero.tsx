    ...
    <section className='relative border-b border-gray-800/50 bg-black'>
      <div className='container mx-auto px-6 lg:px-8 py-12'>
        ...
        >
          ...
          <Link
            href={getMainSiteUrl()}
            className='group flex items-center gap-2 px-4 py-2.5 border border-gray-800/60 bg-gray-950/80 backdrop-blur-sm text-gray-300 text-sm font-medium hover:bg-gray-900/90 hover:text-white hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 rounded-lg'
          >
            <ArrowLeft className='h-4 w-4 text-gray-400 group-hover:text-cyan-400 transition-colors' />
            ...
            <div className='flex flex-col border border-gray-800/60 bg-gray-950/60'>
              ...
              <div className='flex flex-col p-4 space-y-4'>
                ...
                <Button
                  ...
                  className='w-full justify-center border-2 border-cyan-500/50 bg-gradient-to-r from-cyan-600/90 to-cyan-700/80 px-6 py-4 text-base font-semibold text-white hover:from-cyan-500 hover:to-cyan-600 hover:border-cyan-400 transition-all duration-200'
                >
