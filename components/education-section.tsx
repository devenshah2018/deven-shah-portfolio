              ...
              {educationData.map((edu, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      data-item-id={edu.id}
                      className="border border-slate-700/30 bg-slate-900/90 backdrop-blur-sm shadow-xl rounded-xl transition-all duration-500 group overflow-hidden"
                    >
                                  ...
                                  {displayedCourses.map(
                                    (course, courseIndex) => (
                                      ...
                                      >
                                        ...
                                        <span
                                          className="flex-1 text-left text-[0.82rem] text-slate-300 font-medium leading-tight break-words whitespace-normal truncate"
                                          title={course}
                                        >
                                          {course}
                                        </span>
              ...
              {certificationData.map((cert, index) => (
                ...
                >
                  <Card
                    ...
                    className="border border-slate-700/30 bg-slate-900/90 backdrop-blur-sm shadow-xl rounded-xl transition-all duration-300 group"
                  >
                    <CardContent className="p-0">
                      <div className="flex items-start gap-4 p-6">
                        {/* Logo */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="border-t border-slate-700/30 pt-3">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">
                              Industry-recognized certification demonstrating
                              expertise in cloud computing fundamentals, AWS
                              services, security, and best practices for cloud
                              architecture.
                            </p>
                          </div>
                        </div>
