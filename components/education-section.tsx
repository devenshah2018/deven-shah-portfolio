    ...
    <section id='education' className='bg-gradient-to-b from-slate-900 to-slate-950 py-20'>
      <div className='container mx-auto px-2 sm:px-4 md:px-8'>
        ...
        >
          ...
          {/* Enterprise-quality toggle buttons, both left-aligned */}
          <div className='mb-8 flex w-full items-center gap-3'>
            <button
              onClick={() => setActiveTab('education')}
              className={`inline-flex items-center gap-2 rounded-xl px-6 py-2 text-lg font-semibold shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400/60
                ${activeTab === 'education'
                  ? 'bg-blue-600 text-white shadow-blue-500/25 scale-105'
                  : 'bg-slate-800/60 text-slate-200 hover:bg-blue-900/30 hover:text-blue-400'}
              `}
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-xl px-6 py-2 text-lg font-semibold shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-orange-400/60
                ${activeTab === 'certifications'
                  ? 'bg-orange-600 text-white shadow-orange-500/20 scale-105'
                  : 'bg-slate-800/60 text-slate-200 hover:bg-orange-900/30 hover:text-orange-400'}
              `}
                      ...
                      <Card className='group relative flex h-full flex-col overflow-hidden rounded-2xl bg-transparent border-none transition-all duration-300'>
                        ...
                        <CardContent className='relative flex flex-1 flex-col gap-6 p-8 md:flex-row md:items-center'>
                          <div className='flex-shrink-0'>
                            <div className='bg-white/8 relative h-28 w-28 rounded-2xl p-4 shadow-lg backdrop-blur-sm'>
                              <img
                                src={edu.logo}
